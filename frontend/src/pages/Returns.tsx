...
export default function Returns() {
  ...
  return (
    <>
        ...
        <div className="overflow-x-auto">
          <Table>
            <TableHeader className="bg-gray-50 dark:bg-gray-800/50">
              <TableRow>
                {[t("table.studentId"), t("table.studentName"), t("table.item"), t("table.staffName"), t("table.borrowedAt"), t("table.actions")].map(h => (
              ...
              {loading ? (
                ...
                <TableRow key={b.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/40">
                  ...
                  <TableCell className="px-4 py-3">
                    <Button onClick={() => open(b)} size="sm" className="bg-success-500 hover:bg-success-600 text-white">
                      {t("returns.process")}
                    </Button>
                  </TableCell>
                </TableRow>
      ...
      <Modal isOpen={modal && !!selected} onClose={close} className="max-w-md p-6 m-4">
        {selected && (
          <>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 mb-4 space-y-2 text-sm">
              {[
                ...
                [t("table.studentName"), i18n.language === "km" ? selected.student_name_kh : selected.student_name_en],
                [t("table.item"), selected.item_name],
                [t("table.borrowedAt"), new Date(selected.borrowed_date).toLocaleDateString()],
              ].map(([label, value]) => (
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <Button onClick={submit} disabled={saving} className="bg-success-500 hover:bg-success-600 text-white">
